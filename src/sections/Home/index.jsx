...
const Home = () => {
  ...
  return (
    <>
      <section className='relative flex justify-center items-center h-screen text-white' ref={ref} id='home' data-section>
            ...
            <Parallax className='flex flex-col md:flex-row gap-8 items-center justify-center md:text-left'>
              ...
              >
                ...
                <motion.h1 className="mb-6 sm:text-5xl text-3xl font-bold tracking-tight text-gray-900 dark:text-white" variants={textAnimate(2)}>
                  <span className='text-3xl'>¡Hola!</span><br/>soy Jose Manuel
                </motion.h1>
                <motion.p className="mb-2 text-lg leading-8 text-gray-300 max-w-[600px]" variants={textAnimate(4)}>
                  +2 años de experiencia como <span className='text-[#43eeb2] font-bold'>desarrollador web</span> en la creación de aplicaciones web. Con conocimientos en desarrollo tanto de frontend como de backend.
                </motion.p>
                <motion.div className='mb-8' variants={textAnimate(7)}>
